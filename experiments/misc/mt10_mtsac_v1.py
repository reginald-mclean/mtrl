...
def main() -> None:
    ...
    experiment = Experiment(
        exp_name="mt10_mtsac_v1_grad_norm",
        seed=args.seed,
        ...
        algorithm=MTSACConfig(
            num_tasks=10,
            gamma=0.99,
            actor_config=ContinuousActionPolicyConfig(optimizer=OptimizerConfig(max_grad_norm=1.0)),
            critic_config=QValueFunctionConfig(optimizer=OptimizerConfig(max_grad_norm=1.0)),
            num_critics=2,
        ),
